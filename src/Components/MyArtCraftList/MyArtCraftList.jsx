...
import MyArtCraftCard from '../MyArtCraftCard/MyArtCraftCard'; // Make sure this path is correct

const MyArtCraftList = () => {
  const loadedData = useLoaderData(); // Data from loader
  const [data, setData] = useState(loadedData); // State to hold art craft data

  return (
    <div className="mt-[100px]">
      <Helmet>
        <title>My Art Craft List</title> {/* SEO Title */}
      </Helmet>
